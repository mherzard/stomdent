...
!скрин экрана (images/Screenshot_20260606_184532_Telegram.jpg)
Telegram-ассистент стоматологической клиники **STOM** (г. Гавар, Армения). Бот отвечает на вопросы пациентов, помогает с записью, предоставляет информацию об услугах, ценах и послепроцедурных рекомендациях.
